      ...
      <section className="relative min-h-[80vh] flex items-center overflow-hidden bg-background transition-colors duration-500">
        ...
        <div className="container mx-auto grid md:grid-cols-2 gap-8 items-center z-10">
          ...
          <div className="relative h-[500px] hidden md:block">
            <div className="absolute inset-0 bg-gradient-to-br from-background/50 to-transparent dark:from-slate-700/40 dark:to-slate-800/20 z-10 rounded-xl opacity-30 dark:opacity-60 border dark:border-slate-600/50" />
